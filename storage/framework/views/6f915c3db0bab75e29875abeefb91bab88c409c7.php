    ...
    <header class="top-0 left-0 right-0 z-10 flex items-center px-6 py-10 bg-white">
            ...
            <div class="flex items-center">
                ...
                <nav class="items-center hidden lg:flex">
                    <a href="/" class="px-6 py-3 font-medium text-secondary-400">Home
                        <hr class="border-b border-primary-400 <?php echo e(Route::currentRouteName() == 'welcome' ? 'block' : 'hidden'); ?>">
                    </a>
                    <a href="/about" class="px-6 py-3 font-medium hover:border-primary-400 text-secondary-400 ">Über Uns
                        <hr class="border-b border-primary-400 <?php echo e(Route::currentRouteName() == 'about' ? 'block' : 'hidden'); ?>">
                    </a>
                    <a href="/services" class="px-6 py-3 font-medium hover:border-primary-400 text-secondary-400">Dienstleistungen
                        <hr class="border-b border-primary-400  <?php echo e(Route::currentRouteName() == 'services' ? 'block' : 'hidden'); ?>">
                    </a>
                    <a href="/faq" class="px-6 py-3 font-medium hover:border-primary-400 text-secondary-400 ">FAQ's
                        <hr class="border-b border-primary-400 <?php echo e(Route::currentRouteName() == 'faqs' ? 'block' : 'hidden'); ?>">
                    </a>

                    <?php if(!Auth::user()): ?>
                    <a href="/pricing" class="px-6 py-3 mr-3 font-medium hover:border-primary-400 text-secondary-400">Preis
                        <hr class="border-b border-primary-400 <?php echo e(Route::currentRouteName() == 'pricing' ? 'block' : 'hidden'); ?>">
                    </a>
        ...
        <nav id="mobile-menu" class="fixed top-0 right-0 z-50 flex flex-col items-center justify-center hidden w-2/3 h-full overflow-hidden bg-white shadow-lg gap-y-5">
            ...
            <a href="/register" class="w-40 px-6 py-3 font-medium text-center text-white rounded-full custom-button bg-secondary-400 hover:border-primary-400" style="z-index: 999;">Registrieren
                <hr class="border-b border-primary-400  <?php echo e(Route::currentRouteName() == 'register' ? 'block' : 'hidden'); ?>">
            ...
            <a href="/login" class="w-40 px-10 py-3 mx-3 font-medium text-center text-white rounded-full custom-button-inverted bg-primary-400 text-secondary-400" style="z-index: 999;">Login
                <hr class="border-b border-secondary-400  <?php echo e(Route::currentRouteName() == 'login' ? 'block' : 'hidden'); ?>">
                ...
                <div class="w-full text-xl leading-normal text-gray-800 lg:w-1/5 lg:px-2 xl:px-6">
                    ...
                    <div class="sticky inset-0 block lg:hidden">
                        <button z-index="1" id="menu-toggle" class="flex justify-between w-full px-3 py-2 text-sm bg-white border border-gray-600 rounded appearance-none lg:bg-transparent hover:border-primary-400 focus:outline-none">
                            <?php if(Auth::user()->type == 'business' && Request::path() == 'dashboard'): ?>
                            <span class="float-left">Unternehmensprofil</span>
                            <?php elseif(Auth::user()->type == 'business' && Request::path() == 'dashboard/services'): ?>
                            <span class="float-left">Dienstleistungen</span>
                            <?php elseif(Auth::user()->type == 'business' && Request::path() == 'dashboard/employees'): ?>
                            <span class="float-left">Mitarbeiter</span>
                            <?php elseif(Auth::user()->type == 'business' && Request::path() == 'dashboard/planning-calendar'): ?>
                            <span class="float-left">Planungen</span>
                            <?php elseif(Auth::user()->type == 'business' && Request::path() == 'dashboard/booking-calendar'): ?>
                            <span class="float-left">Buchungen</span>
                            <?php elseif(Auth::user()->type == 'business' && Request::path() == 'dashboard/statistics'): ?>
                            <span class="float-left">Statistiken</span>
                            <?php elseif(Auth::user()->type == 'business' && Request::path() == 'dashboard/support'): ?>
                            <span class="float-left">Support</span>
                            <?php elseif(Auth::user()->type == 'business' && Request::path() == 'businesses/subscriptions'): ?>
                    ...
                    <div class="sticky inset-0 z-20 hidden w-full h-64 mt-0 overflow-x-hidden overflow-y-auto bg-white lg:mx-auto lg:h-auto lg:overflow-y-hidden lg:block border-secondary-400 lg:border-transparent lg:shadow-none lg:bg-transparent" style="top:5em;" id="menu-content">
                        <ul class="list-reset">
                            <?php if(Auth::user()->type == 'business' && Auth::user()->subscription): ?>
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <?php if(Auth::user()->type == 'business' && Request::path() == 'dashboard'): ?>
                                <a href="/dashboard" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-primary-400 <?php echo e(Request::path() == 'dashboard' ? 'lg:border-primary-400' : ''); ?>">
                            ...
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <?php if(Auth::user()->type == 'business' && Request::path() == 'dashboard/services'): ?>
                                <a href="/dashboard/services" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/services' ? 'lg:border-primary-400' : ''); ?>">
                            ...
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <?php if(Auth::user()->type == 'business' && Request::path() == 'dashboard/employees'): ?>
                                <a href="/dashboard/employees" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/employees' ? 'lg:border-primary-400' : ''); ?>">
                            ...
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                ...
                                <?php if(Auth::user()->type == 'business' && Request::path() == 'dashboard/planning-calendar'): ?>
                                <a href="/dashboard/planning-calendar" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/planning-calendar' ? 'lg:border-primary-400' : ''); ?>">
                            ...
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <?php if(Auth::user()->type == 'business' && Request::path() == 'dashboard/booking-calendar'): ?>
                                <a href="/dashboard/booking-calendar" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/booking-calendar' ? 'lg:border-primary-400' : ''); ?>">
                            ...
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <?php if(Auth::user()->type == 'business' && Request::path() == 'dashboard/statistics'): ?>
                                <a href="/dashboard/statistics" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/statistics' ? 'lg:border-primary-400' : ''); ?>">
                            ...
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <?php if(Auth::user()->type == 'business' && Request::path() == 'dashboard/support'): ?>
                                <a href="/dashboard/support" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/support' ? 'lg:border-primary-400' : ''); ?>">
                            ...
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <?php if(Auth::user()->type == 'business' && Request::path() == 'businesses/subscriptions'): ?>
                                <a href="/businesses/subscriptions" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'businesses/subscriptions' ? 'lg:border-primary-400' : ''); ?>">
                            ...
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <a href="/dashboard" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard' ? 'lg:border-primary-400' : ''); ?>">
                                    <span class="pb-1 text-sm md:pb-0">Mein Profil</span>
                                </a>
                            </li>
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <a href="/dashboard/bookings" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/bookings' ? 'lg:border-primary-400' : ''); ?>">
                            ...
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <a href="/admin/users" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'admin/users' ? 'lg:border-primary-400' : ''); ?>">
                                    <span class="pb-1 text-sm md:pb-0">Users</span>
                                </a>
                            </li>
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <a href="/admin/faqs" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/bookings' ? 'lg:border-primary-400' : ''); ?>">
                                    <span class="pb-1 text-sm md:pb-0">Faqs</span>
                                </a>
                            </li>
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <a href="/admin/stats" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/bookings' ? 'lg:border-primary-400' : ''); ?>">
                                    <span class="pb-1 text-sm md:pb-0">Stats</span>
                                </a>
                            </li>
                            <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                                <a href="/admin/transactions" class="block pl-4 text-gray-700 no-underline align-middle border-l-4 border-transparent hover:text-primary-400 lg:hover:border-secondary-400 <?php echo e(Request::path() == 'dashboard/bookings' ? 'lg:border-primary-400' : ''); ?>">
...
</script><?php /**PATH /var/www/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>